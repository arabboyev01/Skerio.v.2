                            ...
                            <Box className={classes.cartDesc}>
                                <Box className={classes.cartLeft}>
                                    <Box className={classes.row}>
                                      <Typography className={classes.icon}><Image src={item.priceIcon} alt="image" className={classes.iconImages}/></Typography>
                                      <Typography className={classes.text}>{item.prices}</Typography>
                                    </Box>
                                    <Box className={classes.row}>
                                        <Typography className={classes.icon}><Image src={item.phoneIcon} alt="image" className={classes.iconImages}/></Typography>
                                        <Typography className={classes.text}>{item.phone}</Typography>
                                    </Box>
                                    <Box className={classes.row}>
                                        <Typography className={classes.icon}><Image src={item.adressIcon} alt="image" className={classes.iconImages}/></Typography>
                                        <Typography className={classes.text}>{item.adress}</Typography>
                                    </Box>
                                </Box>
                                <Box className={classes.cartRight}>
                                    <Box className={classes.row}>
                                        <Typography className={classes.icon}><Image src={item.dressRoomIcon} alt="image" className={classes.iconImages}/></Typography>
                                        <Typography className={classes.text}>{item.dressRoom}</Typography>
                                    </Box>
                                    <Box className={classes.row}>
                                        <Typography className={classes.icon}><Image src={item.foodsIcon} alt="image" className={classes.iconImages}/></Typography>
                                        <Typography className={classes.text}>{item.foods}</Typography>
                                    </Box>
                                    <Box className={classes.row}>
                                        <Typography className={classes.icon}><Image src={item.bathroomIcon} alt="image" className={classes.iconImages}/></Typography>
                                        <Typography className={classes.text}>{item.bathRoom}</Typography>
                                    </Box>
                                    <Box className={classes.row}>
                                        <Typography className={classes.icon}><Image src={item.placesIcon} alt="image" className={classes.iconImages}/></Typography>
